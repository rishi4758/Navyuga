...
$insert_customer = "insert into customers (customer_name,customer_email,customer_pass,customer_contact,customer_image,customer_ip,customer_confirm_code) values ('$c_name','$c_email','$encrypted_password','$c_contact','$c_image','$c_ip','$customer_confirm_code')";
