...
<label class="col-md-3 control-label">vendor Job: </label>
...
$insert_admin = "insert into vendors(vendor_name,vendor_email,admin_pass,admin_image,admin_contact,admin_about) values ('$admin_name','$admin_email','$admin_pass','$admin_image','$admin_contact','$admin_about')";
