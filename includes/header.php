			...
			<div class="container-fluid" ><!-- container Starts -->
				...
				<div class="navbar-header"><!-- navbar-header Starts -->
					<a class="home" href="index.php" ><!--- navbar navbar-brand home Starts -->
						<img src="images/logo4.png" alt="computerfever" class="hidden-xs">
						<p class="detail visible-xs">NAV<span class="name">YUGA</span> </p>
...
<div class='Shopcategory_mobile'>
 ...
 $get="select * from customers where customer_email='$q'";
  ...
  <div class="user_section">
						<span class="user_pic">
					<?php echo " 
<a href='customer/my_account.php'><img src='customer/customer_images/$customer_image' class='img-responsive'></a>
		";?>
						</span>
						<a href="customer/my_account.php"><span class="user_name">
						<?php	echo" '$name'";?>
						</span></a>
					</div>
    <?php  } ?>
...
while($row_cat=mysqli_fetch_array($run_cat))
{
$p_cat=$row_cat['p_cat_id'];

$p_cat_title=$row_cat['p_cat_title'];	
echo"
 <li><a href='index.php?p_cat=$p_cat '>$p_cat_title</li>";
...
<li><a href="my_account.php" class="btn btn-success">my_account</a></li>
